    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          ...
          <div key={c.label} style={{ animationDelay: `${i * 0.07}s` }} className="animate-staggerIn bg-white rounded-xl p-5 shadow-sm border border-green-200 hover:shadow-md hover:-translate-y-0.5 hover:border-green-300 transition-all duration-200">
